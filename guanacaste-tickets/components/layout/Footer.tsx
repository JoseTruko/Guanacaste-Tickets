        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              {/* TikTok */}
              <a href="#" aria-label="TikTok" className="text-green-200 hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              href="mailto:info@guanacastetickets.com"
              className="flex items-center gap-2 text-green-200 hover:text-white text-sm transition-colors mt-2 min-w-0"
            >
              ...
              <span className="break-all">info@guanacastetickets.com</span>
            </a>
          </div>
        </div>
