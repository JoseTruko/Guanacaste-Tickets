...
const HERO_IMAGE = { src: '/images/santarosatour.webp.webp', alt: 'Wildlife and trails at Santa Rosa National Park' };
...
export default function ToursHero({ searchQuery, onSearchChange }: Props) {
  return (
    <section className="relative flex items-center overflow-hidden" style={{ height: 'clamp(320px, 42vh, 440px)' }}>
      ...
      <div className="relative z-20 w-full max-w-3xl mx-auto px-4 text-center flex flex-col items-center gap-4">
        ...
        <p className="text-white/85 text-sm md:text-base max-w-xl">
          Adventure, wildlife, and nature experiences — led by local guides, booked direct at the best price.
        </p>
