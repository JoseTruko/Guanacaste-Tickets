    ...
    <section className="relative flex items-center justify-center text-center overflow-hidden" style={{ height: 'calc(100vh - 4rem)' }}>
      ...
      <div className="relative z-10 flex flex-col items-center gap-5 px-4 max-w-3xl mx-auto">
        ...
        <p className="text-white/90 text-lg md:text-xl animate-fade-up delay-300">
          Handpicked tours with local experts.<br className="hidden sm:block" /> Free cancellation on most tours.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 animate-fade-up delay-400">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-semibold px-8 py-3 rounded-lg hover:bg-[#1ebe5d] transition-colors text-base shadow-lg"
          >
        ...
        {/* Trust badges */}
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-2 animate-fade-up delay-500 mt-1">
          {[
            '✓ Free Cancellation',
            '✓ Best Price',
            '✓ Local Experts',
            ...
            <span key={badge} className="text-white/85 text-sm font-medium">
              {badge}
            </span>
          ))}
        </div>
