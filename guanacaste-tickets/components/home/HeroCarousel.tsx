...
export default function HeroCarousel({ images }: Props) {
  ...
  return (
    <section className="relative flex items-center overflow-hidden" style={{ height: 'clamp(560px, 75vh, 820px)' }}>
      ...
      {/* Overlay — dark wash plus a left-side gradient so the copy stays readable on any photo */}
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 md:pl-12 lg:pl-20">
        <div className="flex flex-col items-center text-center md:items-start md:text-left gap-5 md:max-w-xl">
          <p className="flex items-center gap-2 text-white/80 text-xs font-semibold uppercase tracking-widest animate-fade-up delay-100">
          ...
          <div className="flex flex-col sm:flex-row gap-3 animate-fade-up delay-400">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-whatsapp text-white font-semibold px-7 py-2.5 border border-whatsapp rounded-sm hover:bg-whatsapp-hover transition-colors text-sm shadow-lg"
            >
