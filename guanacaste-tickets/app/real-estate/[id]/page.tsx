    ...
    <main className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
        ...
        <div className="text-right">
          <p className="text-3xl font-bold text-[#0077B6]">${property.price.toLocaleString('en-US')}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {property.amenities.map((a) => (
                  <span key={a} className="flex items-center gap-2 bg-green-50 text-green-800 text-sm font-medium px-4 py-2 rounded-full">
        ...
        <div className="lg:col-span-1">
          <div className="lg:sticky lg:top-6 bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-4">
            <div>
              <p className="text-2xl font-bold text-[#0077B6]">${property.price.toLocaleString('en-US')} <span className="text-sm font-normal text-gray-400">USD</span></p>
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full bg-[#25D366] text-white font-semibold py-3 rounded-lg hover:bg-[#1ebe5d] transition-colors"
            >
